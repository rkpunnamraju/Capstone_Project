...
def get_pie_chart(entered_site):
    ...
    selectedsitedf = spacex_df[spacex_df['Launch Site']==entered_site]
    dfwithSuccess = spacex_df[spacex_df['class']==1]
    #selected_df = spacex_df[selectedsitedf & dfwithSuccess] 
    if entered_site == 'ALL':
        fig = px.pie(dfwithSuccess, values='class', 
        names='Launch Site', 
        title='Total success launches by Site')
        return fig
    else:
        # return the outcomes piechart for a selected site
       # fig = px.pie(selectedsitedf, values='class', 
       # names='Launch Site', 
       # title=f"Pie Chart for {entered_site} Site Name")
       # return fig
